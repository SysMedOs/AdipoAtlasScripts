...
class LipostarParser:
    ...
    def merge_info(self, output_path, score=60, peaks=2):
        ...
        for gp in self.group_abbr_dct:
            sorted_sum_df.at[:, gp] = sorted_sum_df[self.group_abbr_dct[gp]].sum(axis=1)
...
if __name__ == '__main__':
    ...
    merged_output = r'../Lipostar/output/GL/Lipostar_GL_sum4.xlsx'

    sum_file_info_dct = {}
    usr_header_info = r'../Configurations/Headers.xlsx'

    sum_file_info_dct['Polar_Pos_GL'] = {
        'file_groups': r'../Configurations/file_groups_Polar_Pos.xlsx',
        'sum_csv': r'../Lipostar/data/GL/Polar_Pos_GL_1.csv',
        'top_csv': r'../Lipostar/data/GL/Polar_Pos_GL_2.csv',
        'dbi_csv': r'../Lipostar/data/GL/Polar_Pos_GL_3.csv',
        'output_path': r'../Lipostar/output/GL/Lipostar_Polar_Pos_GL.xlsx',
        'addut_lst': ['[M+NH4]+'],
        'score': 60, 'peaks': 3,
    }
    sum_file_info_dct['Polar_Pos_GL_IT'] = {
        'file_groups': r'../Configurations/file_groups_Polar_Pos_IT.xlsx',
        'sum_csv': r'../Lipostar/data/GL/Polar_Pos_GL_IT_1.csv',
        'top_csv': r'../Lipostar/data/GL/Polar_Pos_GL_IT_2.csv',
        'dbi_csv': r'../Lipostar/data/GL/Polar_Pos_GL_IT_3.csv',
        'output_path': r'../Lipostar/output/GL/Lipostar_Polar_Pos_GL_IT.xlsx',
        'addut_lst': ['[M+NH4]+'],
        'score': 60, 'peaks': 3,
    }
    sum_file_info_dct['Unpolar_Pos_GL'] = {
        'file_groups': r'../Configurations/file_groups_Unpolar_Pos.xlsx',
        'sum_csv': r'../Lipostar/data/GL/Unpolar_Pos_GL_1.csv',
        'top_csv': r'../Lipostar/data/GL/Unpolar_Pos_GL_2.csv',
        'dbi_csv': r'../Lipostar/data/GL/Unpolar_Pos_GL_3.csv',
        'output_path': r'../Lipostar/output/GL/Unpolar_Pos_GL.xlsx',
        'addut_lst': ['[M+NH4]+'],
        'score': 60, 'peaks': 3,
    }
    sum_file_info_dct['Unpolar_Pos_GL_AquireX'] = {
        'file_groups': r'../Configurations/file_groups_Unpolar_Pos_AquireX.xlsx',
        'sum_csv': r'../Lipostar/data/GL/Unpolar_Pos_GL_AquireX_1.csv',
        'top_csv': r'../Lipostar/data/GL/Unpolar_Pos_GL_AquireX_2.csv',
        'dbi_csv': r'../Lipostar/data/GL/Unpolar_Pos_GL_AquireX_3.csv',
        'output_path': r'../Lipostar/output/GL/Unpolar_Pos_GL_AquireX.xlsx',
        'addut_lst': ['[M+NH4]+'],
        'score': 60, 'peaks': 3,
    }
