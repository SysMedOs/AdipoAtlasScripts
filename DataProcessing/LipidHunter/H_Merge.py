    ...
    def merge_xlsx(self, cfg_df):
        ...
        for i, r in cfg_df.iterrows():
            ...
            if r['lipid_class'].startswith('P'):
                ...
                fa_tmp_df = _fa_tmp_df[tmp_df['FA2_[FA-H]-_i'] > 0]
    ...
    def unique_features(self, sum_df, rank_score=40, isotope_score=80):
        ...
        for discrete in unique_discrete_lst:
            ...
            if not r_df.empty:
                ...
                if discrete == 'TG(11:0_14:1_18:1)':
                    self.logger.error('Nothing identified')
                    self.logger.error(tmp2_df)
                    self.logger.error(tmp1_df)
                    sum_test_df = sum_df[sum_df['DISCRETE_ABBR'] == 'TG(11:0_14:1_18:1)']
                    self.logger.error(r_df)
...
if __name__ == '__main__':
    ...
    hunter_cfg.load_batch_cfg(usr_cfg_lst, merge_table=usr_output_path, rank_score=40, isotope_score=80)
